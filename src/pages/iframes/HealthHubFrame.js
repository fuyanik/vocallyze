...
<div onClick={()=>{window.close()}}>
  <a  class="flex items-center px-4 py-2 overflow-hidden transition-colors duration-200 ease-out rounded-md hover:bg-neutral-100/75 text-base group" href="https://www.hub.medifyre.com/adrenal-glands" target="_blank">
