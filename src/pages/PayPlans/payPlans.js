...
const PayPlans = ({ isOutside = false, }) => {
 ...
 <>
   ...
   <Popup
    ...
    <img className="absolute sm:flex    w-full h-full  object-cover -z-10" src="https://vitamu.imgix.net/Ads%C4%B1z%20tasar%C4%B1m-10.png?w=6400&h=3371&rect=0%2C0%2C6400%2C3371&auto=compress" alt="groupPng"/>
      <div className='absolute  px-8 flex items-center justify-between w-full'>
          <img className='w-32'  src="https://vitamu.imgix.net/MEDIFYRE-6.png?w=6400&h=3600&ar=6400%3A3600"/>
       ...
       <div className='w-full h-full flex items-center justify-evenly'>
         ...
         <div onClick={()=>{ AmountCalculator(mainPayAmount); setIsPopupOpen(true) } }  onMouseMove={()=>{setSelectedCard(1);  } }   className='h-[80%] cursor-pointer hover:mb-5 duration-500  w-[30%] bg-white/40 backdrop-filter backdrop-blur-xl  border rounded-tr-[50px] rounded-bl-[50px] p-10 text-black'>
            ...
            <div className='flex flex-col gap-5 w-fit '>
              ...
              <div class="flex items-center gap-1 ">
                ...
                <p class="text-[34px] ">  ${VariableCalculator(planOneValue) | 0} {" "} / </p>
              ...
              <div className='flex flex-col gap-4 items-start  '>
                  <div className='flex items-center justify-center gap-4 '> {svgTik} <p>Detailed second opinion report</p> </div>
                  <div className='flex items-center justify-center gap-4 '> {svgTik} <p>Marked images with personalized radiologist notes</p> </div>
                  <div className='flex items-center justify-center gap-4 '> {svgTik} <p>Ask a radiologist (Limited Questions) </p> </div>
         ...
         <div onClick={()=>{ AmountCalculator(mainPayAmount); setIsPopupOpen(true) } }  onMouseMove={()=>{setSelectedCard(2);  }}  className='h-[80%] animate-fadeIn cursor-pointer  hover:mb-5 duration-500  w-[30%] bg-white/60 backdrop-filter backdrop-blur-md shadow-lg  rounded-tr-[50px] rounded-bl-[50px] p-10 text-black '>
              ...
              <div className='flex items-center justify-center gap-3'>
               ...
               <p class="text-[34px] ">  ${VariableCalculator(planTwoValue) | 0} {" "} / </p>
               ...
               <div className='flex flex-col gap-4 items-start  '>
                   <div className='flex items-center justify-center gap-4 '> {svgTik} <p>5-second opinions (all body parts)</p> </div>
                   <div className='flex items-center justify-center gap-4 '> {svgTik} <p>Detailed second opinion report</p> </div>
                   <div className='flex items-center justify-center gap-4 '> {svgTik} <p>Marked images with personalized radiologist notes</p> </div>
         ...
         <div onClick={()=>{ AmountCalculator(mainPayAmount); setIsPopupOpen(true) } }  onMouseMove={()=>{setSelectedCard(3);}} className='h-[80%] cursor-pointer  hover:mb-5 duration-500 r w-[30%] bg-[linear-gradient(0deg,_hsla(179,23%,48%,1)_0%,_hsla(166,39%,65%,1)_100%)] shadow-xl border rounded-tr-[50px] rounded-bl-[50px] p-10 text-black'>
            ...
            <div className='flex flex-col gap-5 w-fit text-white '>
              ...
              <p class="text-[34px] ">  ${VariableCalculator(planThreeValue) | 0} {" "} / </p>
               ...
               <p className='text-[#fffcfc] text-sm'> {( gV.insuranceCompany !== "I do not have an active insurance plan." | gV.insuranceCompany !== "My insurance is not listed."  | gV.insuranceCompany !== "none"   ) && gV.insuranceCompany}</p>
             
              </div>

              <div className='flex flex-col gap-4 items-start '>
                  <div className='flex items-center justify-center gap-4 '> {svgTikWhite} <p>5 radiology second opinions per year</p> </div>
                  <div className='flex items-center justify-center gap-4 '> {svgTikWhite} <p>Detailed second opinion report</p> </div>
                  <div className='flex items-center justify-center gap-4 '> {svgTikWhite} <p>Marked images with personalized radiologist notes</p> </div>
