  ...
  return (
    <div className='password-reset'>
       <ToastContainer/>
           ...
           <img alt="image" src="https://vitamu.imgix.net/Group%202.png?auto=undefined%2Ccompress" className="login-page__main__logo"/>
           ...
           <div className='password-reset__main'>
                ...
                <div onClick={handleResetPassword} className="w-2/4 bg-pri text-white rounded-full py-2 items-center justify-center flex text-sm cursor-pointer">Send Password Reset</div>
           </div>
