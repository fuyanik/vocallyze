        ...
        >
         ...
         <div className="flex flex-col gap-1 text-sm ">
           ...
           <div class="flex items-center gap-3">
             ...
             <p class="color--black">Marked images with radiologist notes</p>
           </div>
           ...
           <div class="flex items-center gap-3">
             ...
             <p class="color--black">Ask a radiologist (Limited Questions)</p>
           </div>
           ...
           <div class="flex items-center gap-3">
             ...
             <p class="color--black">Follow-up consultation</p>
           </div>
          ...
          <SwiperSlide  className="hidden flex-col gap-2 border  bg-slate-100 text-pri  px-3 pt-3 ">
            ...
            <div className="flex gap-3 items-center justify-center">
              <svg
               ...
               >
                 ...
                 <p className="text-[22px]">One - Year </p>
            </div>
            <p className='px-4 py-1 rounded-full bg-[linear-gradient(0deg,_hsla(179,23%,48%,1)_0%,_hsla(166,39%,65%,1)_100%)] text-white'>Best Value</p>
             </div>
            ...
            <div className="flex flex-col gap-1 text-sm ">
              ...
              <svg
                ...
                <p class="color--black relative">Follow-up consultation</p>
              </div>
           ...
           <SwiperSlide  className="hidden  flex-col gap-2 bg-[linear-gradient(0deg,_hsla(179,23%,48%,1)_0%,_hsla(166,39%,65%,1)_100%)]    text-white px-5 pt-5">
            <header className="flex items-center justify-between">
             <div className="flex gap-3 items-center justify-center">
             <svg
                 width="32"
               ...
               >
                 ...
                 <p className="text-[22px]">Lifetime</p>
             </div>
            ...
            { ( gV.insuranceCompany !== "I do not have an active insurance plan." && gV.insuranceCompany !== "My insurance is not listed."  && gV.insuranceCompany !== "none"   ) &&  <p class="pay-card__value-area__period">
              ...
              <p style={{color:"#f5f5f5"}}> {( gV.insuranceCompany !== "I do not have an active insurance plan." && gV.insuranceCompany !== "My insurance is not listed."  && gV.insuranceCompany !== "none"   ) && gV.insuranceCompany}</p>
            </div>
            ...
            <div className="flex flex-col gap-1 text-sm">
              ...
              <div class="flex items-center gap-3">
                ...
                <p class="">Marked images with radiologist notes</p>
              </div>
              ...
              <div class="flex items-center gap-3">
                ...
                <p class="">Follow-up consultation</p>
              </div>
