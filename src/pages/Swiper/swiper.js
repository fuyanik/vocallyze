...
useEffect(() => {
  ...
  return (
    <>
      ...
      <div onClick={()=>{ isPopupOpen &&  setIsPopupOpen(false)}}  className={`${isPopupOpen ? "Swiper-Page-blur" : "Swiper-Page" }`}>
        ...
        >
         ...
         <SwiperSlide className="flex flex-col bg-white">
            <div class="">
              <svg
                width="30"
                height="30"
           ...
           { gV.insuranceCompany !== "none" &&    <p class="pay-card__value-area__period">
            ...
            <div class="pay-card__hero">
              <div class="pay-card__hero__features">
                ...
                <p class="color--black">Detailed recheck report</p>
              </div>
              ...
              <div class="pay-card__hero__features">
                ...
                <p class="color--black">Personalized radiologist notes </p>
              </div>
              ...
              <div class="pay-card__hero__features">
                ...
                <p class="color--black">AI marked medical images</p>
              </div>
           ...
           {/* Smart */}
          <SwiperSlide  className="pay-card border-2 bg-white flex flex-col">
       ...
       { /*    <div
           ...
           {/* Lifelong */}
          <SwiperSlide className="bg-[#1769FF] flex flex-col font-product items-start justify-start">
            ...
            <div class="">
              ...
              <div class="pay-card__hero__features">
                ...
                <p>Personalized radiologist notes</p>
              </div>
            ...
            ForwardBackButtons(
              ...
              gV.payPlan = "Three"
              setIsPopupOpen(true)
              AmountCalculator(planThreeValue)
              },
