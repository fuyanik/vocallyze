    ...
    style={{ zIndex:"1",width:width, display:"flex", flexDirection:"column", gap:"0px"}}    >
      ...
      >
        ...
        <div style={{display:"flex", flexDirection:"column", gap:"20px"}}>
          ...
          <p style={{display:"flex", flexDirection:"row",width:"100%", gap:"6px", color:"gray"}} className="normal-text">Drop us an-mail: <a className="style-none"  href="mailto:hello@vitamu.com"><span  style={{fontFamily:"ProductSans-Thin"}}>hello@vitamu.com</span> </a>  </p>
