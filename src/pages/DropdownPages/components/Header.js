...
const DropdownHeader = ({yellow_title, title, subtitle, writer, date, checker,display=true}) => {
  ...
  { display &&  <>
        <div className="dropdown-page-header__subtitle">
          {subtitle}
        </div>
  
        <div className="dropdown-page-header__name-date">
          <div className="dropdown-page-header__name-date__name">
           <p> By <span> {writer} </span> </p>
          </div>
        
          <div className="dropdown-page-header__name-date__date flex items-center  gap-2">
          <div className="dropdown-page-header__name-date__circle "></div>
            {" "}
            {date}{" "}
          </div>
        </div>
  
        <div className="dropdown-page-header__checked">
          {" "}
          <svg
          ...
          >
            ...
            <path
              fill="#f1bc19"
              d="M77 12A1 1 0 1 0 77 14 1 1 0 1 0 77 12zM83 11A4 4 0 1 0 83 19 4 4 0 1 0 83 11z"
            ></path>
            <path
              fill="#88ae45"
            ...
            <g>
              ...
              <path
                fill="#fdfcef"
                d="M50 30.5A19.5 19.5 0 1 0 50 69.5A19.5 19.5 0 1 0 50 30.5Z"
              ></path>
              <path
                fill="#472b29"
          ...
          <p>Fact checked by <span>{checker}</span></p>
        </div>
