...
// and the labels read EN/TR instead of LIGHT/DARK. Backed by the shared
// LocaleProvider context, so every toggle instance on the page (desktop +
// mobile navbar, inline hero nav) stays in sync and switches all copy
// instantly — no route change, no reload.
const FLAGS = {
