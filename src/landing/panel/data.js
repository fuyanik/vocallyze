...
export const AI_INTENTS = [
  { id: "debt-inquiry", intent: "Debt inquiry", auto: 96, volume: 428, state: "live" },
  { id: "payment-plan-info", intent: "Payment plan info", auto: 91, volume: 384, state: "live" },
  { id: "receipt-verification", intent: "Receipt verification", auto: 88, volume: 297, state: "live" },
  { id: "file-status", intent: "File status", auto: 84, volume: 264, state: "pilot" },
  { id: "address-update", intent: "Address update", auto: 79, volume: 176, state: "pilot" },
  { id: "restructuring-request", intent: "Restructuring request", auto: 62, volume: 341, state: "training" },
  { id: "objection-process", intent: "Objection process", auto: 41, volume: 218, state: "training" },
  { id: "legal-advice", intent: "Legal advice", auto: 12, volume: 156, state: "human" },
];
